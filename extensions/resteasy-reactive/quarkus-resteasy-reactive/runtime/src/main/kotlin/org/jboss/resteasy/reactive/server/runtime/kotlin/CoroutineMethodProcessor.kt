...
open class CoroutineMethodProcessor(public var supplier: Supplier<EndpointInvoker>? = null) : HandlerChainCustomizer {
    ...
    override fun alternateInvoker(method: ServerResourceMethod): Supplier<EndpointInvoker> {
        return supplier as Supplier<EndpointInvoker>;
    }
}