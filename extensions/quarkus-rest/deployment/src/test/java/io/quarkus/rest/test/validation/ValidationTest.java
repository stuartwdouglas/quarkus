...
public class ValidationTest {
            ...
            .setArchiveProducer(new Supplier<JavaArchive>() {
                ...
                public JavaArchive get() {
                    ...
                    return TestUtil.finishContainerPrepare(war, null, ValidationResourceWithAllViolationTypes.class,
                            ValidationResourceWithReturnValues.class, ValidationFooReaderWriter.class,
                            ValidationFooValidator.class,
    ...
    public void testViolationsBeforeReturnValue() throws Exception {
        ...
        Assert.assertTrue(violation.getValue()
                .startsWith("io.quarkus.rest.test.validation.resource.ValidationResourceWithAllViolationTypes@"));
