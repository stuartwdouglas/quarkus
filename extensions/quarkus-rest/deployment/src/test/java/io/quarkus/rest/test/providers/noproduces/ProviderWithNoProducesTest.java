 ...
 */
@DisplayName("Provider With No Produces Test")
public class ProviderWithNoProducesTest {
    ...
    public void testWriteFoo() throws Exception {
        ...
        Assertions.assertEquals("ProviderWithNoProducesMessageBodyWriter", response.readEntity(String.class),
