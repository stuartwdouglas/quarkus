...
import io.quarkus.rest.test.rx.rxjava2.resource.Rx2ObservableResource;
import io.quarkus.rest.test.rx.rxjava2.resource.Rx2ObservableResourceImpl;
    ...
    static QuarkusUnitTest testExtension = new QuarkusUnitTest()
            .setArchiveProducer(new Supplier<JavaArchive>() {
                ...
                public JavaArchive get() {
                    ...
                    return TestUtil.finishContainerPrepare(war, null, Rx2ObservableResourceImpl.class,
