...
import io.quarkus.rest.test.cdi.injection.resource.ReverseInjectionEJBHolder;
import io.quarkus.rest.test.cdi.injection.resource.ReverseInjectionEJBHolderLocal;
import io.quarkus.rest.test.cdi.injection.resource.ReverseInjectionEJBHolderRemote;
import io.quarkus.rest.test.cdi.injection.resource.ReverseInjectionEJBInterface;
import io.quarkus.rest.test.cdi.injection.resource.ReverseInjectionResource;
import io.quarkus.rest.test.cdi.injection.resource.StatefulApplicationScopedEJBwithJaxRsComponents;
import io.quarkus.rest.test.cdi.injection.resource.StatefulApplicationScopedEJBwithJaxRsComponentsInterface;
import io.quarkus.rest.test.cdi.injection.resource.StatefulDependentScopedEJBwithJaxRsComponents;
import io.quarkus.rest.test.cdi.injection.resource.StatefulDependentScopedEJBwithJaxRsComponentsInterface;
import io.quarkus.rest.test.cdi.injection.resource.StatefulRequestScopedEJBwithJaxRsComponents;
import io.quarkus.rest.test.cdi.injection.resource.StatefulRequestScopedEJBwithJaxRsComponentsInterface;
import io.quarkus.rest.test.cdi.injection.resource.StatelessEJBwithJaxRsComponents;
import io.quarkus.rest.test.cdi.injection.resource.StatelessEJBwithJaxRsComponentsInterface;
...
public class ReverseInjectionTest extends AbstractInjectionTestBase {
    ...
    private void doTestSFSB(String scope) throws Exception {
        ...
        Class<?> viewName = Class.forName("io.quarkus.rest.test.cdi.injection.resource." + className + "Interface");
