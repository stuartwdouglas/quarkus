 ...
 */
@DisplayName("Bean Reader Writer Test")
public class BeanReaderWriterTest {
    ...
    static QuarkusUnitTest testExtension = new QuarkusUnitTest().setArchiveProducer(new Supplier<JavaArchive>() {
        ...
        public JavaArchive get() {
            ...
            war.addClasses(BeanReaderWriterConfigBean.class, BeanReaderWriterService.class, BeanReaderWriterXFormat.class,
    ...
    public void testIt2() throws Exception {
        ...
        Assertions.assertEquals(format, "foo 1.1");
        response.close();
        client.close();
    }
}
